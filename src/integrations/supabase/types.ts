  ...
  public: {
    Tables: {
      ...
      transaksi: {
        ...
        Relationships: [
          {
            foreignKeyName: "transaksi_nasabah_id_fkey"
            columns: ["nasabah_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      transaksi_detail: {
        ...
        Relationships: [
          {
            foreignKeyName: "transaksi_detail_jenis_sampah_id_fkey"
            columns: ["jenis_sampah_id"]
            isOneToOne: false
            referencedRelation: "jenis_sampah"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "transaksi_detail_transaksi_id_fkey"
