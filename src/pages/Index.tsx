  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden font-poppins">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-secondary rounded-full blur-3xl animate-float" style={{ animationDelay: '4s' }} />
      </div>
      ...
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-md border-b border-border/50">
        <div className="container mx-auto px-4 h-[78px] flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-foreground">e-Bank Sampah</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p 
                data-aos="fade-up" 
                data-aos-delay="300"
                className="text-lg text-muted-foreground max-w-xl mb-8 leading-relaxed font-lora"
              >
              ...
              >
                <Button 
                  ...
                  className="gap-2 px-8 py-6 text-lg font-semibold shadow-elegant hover:shadow-carousel transition-all duration-300 hover:scale-105 animate-pulse-glow"
                >
                  Mulai Sekarang
                ...
                <Button 
                  ...
                  variant="outline" 
                  onClick={() => navigate("/auth")}
                  className="px-8 py-6 text-lg font-semibold hover:bg-secondary transition-all duration-300 hover:scale-105 border-2 border-primary"
                >
                  Daftar Gratis
                </Button>
              </div>
            ...
            >
              <div className="relative w-full aspect-square max-w-lg mx-auto">
                ...
                {/* Floating elements */}
                <div className="absolute top-10 right-10 w-16 h-16 bg-primary/20 rounded-2xl flex items-center justify-center animate-float" style={{ animationDelay: '1s' }}>
                  <Coins className="w-8 h-8 text-primary" />
                </div>
                <div className="absolute bottom-20 left-5 w-14 h-14 bg-accent/20 rounded-2xl flex items-center justify-center animate-float" style={{ animationDelay: '2s' }}>
      ...
      <section id="layanan" className="py-20 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span 
              data-aos="fade-up"
              className="hero-subtitle text-sm mb-4 inline-block"
            >
              Layanan Kami
            </span>
            <h2 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card 
              data-aos="fade-up" 
              data-aos-delay="100"
              className="group border-0 shadow-elegant hover:shadow-carousel transition-all duration-500 hover-lift bg-card"
            >
      ...
      <section id="cara-kerja" className="py-20">
        <div className="container mx-auto px-4">
          <div 
            data-aos="fade-up"
            className="glass-card rounded-3xl p-10 md:p-14 shadow-carousel"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                ...
                { step: "2", title: "Kumpulkan", desc: "Pisahkan dan kumpulkan sampah berdasarkan jenisnya" },
                { step: "3", title: "Setor", desc: "Setor sampah Anda ke bank sampah dan dapatkan saldo" },
                { step: "4", title: "Cairkan", desc: "Tarik saldo Anda menjadi uang tunai" },
              ].map((item, index) => (
                <div 
                  key={index}
                  data-aos="zoom-in"
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-primary/10 to-accent/5 rounded-3xl p-12 md:p-16 border border-primary/20 shadow-carousel">
              ...
              <Button 
                size="lg" 
                onClick={() => navigate("/auth")} 
                className="gap-2 px-10 py-6 text-lg font-semibold shadow-elegant hover:shadow-carousel transition-all duration-300 hover:scale-105"
              >
                Bergabung Sekarang
                <ArrowRight className="w-5 h-5" />
              </Button>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xl font-bold">e-Bank Sampah</span>
              </div>
